...
console.log(dueDateTime);  // NOTE: This approach of outputting a string value results in the conversion of some characters to HTML entities and the escaping of quotation marks so the results look a bit goofy. To avoid this situation, simply output this HTML element by first using the document.createElement() method, setting the datetime attribute, adding the inner text, and injecting into the page.